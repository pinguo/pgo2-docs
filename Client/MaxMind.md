...
NewMaxMindPool(iObj iface.IObject, componentId ...interface{}) // 对象池 this.GetObjPool(adapter.MaxMindClass,adapter.NewMaxMindPool).(adapter.IMaxMind)/(*adapter.MaxMind) 
